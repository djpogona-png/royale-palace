...
<body>
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @hasrole('super_admin')
            <p class="nav-group-label">Super Admin</p>
            ...
            <a href="{{ route('admin.reservaciones.reporte') }}" class="nav-item">
                <i class="bi bi-file-earmark-pdf"></i> Reporte PDF
            </a>

            <p class="nav-group-label">Sitio</p>
            ...
            <div class="sidebar-user">
                ...
                <div class="sidebar-user-info">
                    ...
                    <div class="sidebar-user-role">
                        ...
                        @elsehasrole('admin_san_salvador') Admin · San Salvador
                        @elsehasrole('admin_santa_ana') Admin · Santa Ana
                        @elsehasrole('admin_san_miguel') Admin · San Miguel
                        @endhasrole
                    </div>
                </div>
            </div>
