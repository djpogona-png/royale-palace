...
<body>
    ...
    <nav class="trp-navbar" id="trpNavbar">
        ...
        <ul class="trp-nav-links d-none d-lg-flex">
            ...
            <li><a href="{{ route('menu.index') }}" class="{{ request()->routeIs('menu.*') ? 'active' : '' }}">Menú</a></li>
            <li><a href="{{ route('reservaciones.create') }}" class="{{ request()->routeIs('reservaciones.*') ? 'active' : '' }}">Reservaciones</a></li>
        ...
        <div class="trp-nav-right d-none d-lg-flex">
            ...
            @else
                <a href="{{ route('login') }}" style="padding: 12px 14px; color: var(--color-dark); font-size: 0.7rem; font-weight: 600; letter-spacing: 1.5px; text-transform: uppercase; text-decoration: none; display: flex; align-items: center; gap: 6px;">
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer">
            @auth
                <a href="{{ route('cuenta.index') }}" onclick="closeMobileMenu()" style="background: var(--color-bg-soft); color: var(--color-dark);">
                    <i class="bi bi-person-circle"></i> Mi Cuenta
                </a>
                @if(Auth::user()->hasAnyRole(['super_admin', 'admin_san_salvador', 'admin_santa_ana', 'admin_san_miguel']))
                    <a href="{{ route('admin.dashboard') }}" onclick="closeMobileMenu()" style="background: var(--color-bg-soft); color: var(--color-dark);">
